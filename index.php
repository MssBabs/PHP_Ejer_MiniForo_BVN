        ...
        <div id="container" style="width: 450px;">
            ...
            <div id="content">
                <?php 
                    ...
                    if ( !isset($_REQUEST['orden']) ){  /*$_REQUEST-> si se ha pulsado el boton*/
                        ...
                        switch ($_REQUEST['orden']){
                            ...
                            case "Entrar":
                                /* CHEQUEAR USUARIO:
                                    - USUARIO REGISTRADO-> MOSTRAR FORMULARIO Y ACEPTARA COMENTARIOS
                                    - USUARIO NO REGISTRADO-> NO MOSTRAR FORMULARIO NI ACEPTARA COMENTARIOS */
